...
from include.fTrace import clsTrace
...
def start_process(config_file):
    ...
    __prc_cycletime=ini_config.CycleTime.prc_stmManualScan_cycletime
    __prc_expiretime=ini_config.CycleTime.prc_stmManualScan_expiretime
    __prc_healthytime=ini_config.CycleTime.prc_stmManualScan_healthytime
