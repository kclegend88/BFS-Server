...
from include.fBarcode import barcode_existingcheck
...
from include.fHIKCamera import clsHIKCameraClient
...
def start_process(config_file):
    ...
    __prc_cycletime=ini_config.CycleTime.prc_HIKCamera_cycletime
    __prc_expiretime=ini_config.CycleTime.prc_HIKCamera_expiretime
    __prc_healthytime=ini_config.CycleTime.prc_HIKCamera_healthytime
    # 定制化配置参数读取：相机连接参数
    __prc_tcp_ip = ini_config.Network.Barcode_Reading_IP
    __prc_tcp_port = ini_config.Network.Barcode_Reading_Port
