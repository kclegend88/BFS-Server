...
def start_process(config_file):
    ...
    __prc_cycletime=ini_config.CycleTime.prc_BarcodeCheck_cycletime
    __prc_expiretime=ini_config.CycleTime.prc_BarcodeCheck_expiretime
    __prc_healthytime=ini_config.CycleTime.prc_BarcodeCheck_healthytime
    ...
    while b_thread_running:
        ...
        try:
            ...
            inst_logger.error("Barcode Check 线程出现致命错误:"+traceback.format_exc())
