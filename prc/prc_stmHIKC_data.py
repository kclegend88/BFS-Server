...
def start_process(config_file):
    ...
    __prc_cycletime=ini_config.CycleTime.prc_stmHIKC_cycletime
    __prc_expiretime=ini_config.CycleTime.prc_stmHIKC_expiretime
    __prc_healthytime=ini_config.CycleTime.prc_stmHIKC_healthytime
