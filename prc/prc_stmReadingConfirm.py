...
def start_process(config_file):
    ...
    __prc_cycletime=ini_config.CycleTime.prc_stmReadingConfirm_cycletime
    __prc_expiretime=ini_config.CycleTime.prc_stmReadingConfirm_expiretime
    __prc_healthytime=ini_config.CycleTime.prc_stmReadingConfirm_healthytime
